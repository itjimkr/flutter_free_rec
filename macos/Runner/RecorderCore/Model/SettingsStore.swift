...
final class SettingsStore {
    ...
    var captureSystemAudio: Bool {
        get {
            ...
            return UserDefaults.standard.object(forKey: "captureSystemAudio") as? Bool ?? true
        }
        set {
    ...
    /// The default output directory (Movies/Rec)
    var defaultOutputDirectory: URL {
        URL.homeDirectory.appending(path: "Movies/Rec")
    }
    ...
    func generateFilename() -> String {
        ...
        return "Rec_\(timestamp).\(containerFormat.fileExtension)"
    }
